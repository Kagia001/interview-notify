...
Heads up: the original project sends anonymous telemetry via ntfy. Specifically, your nick hashed, mode (red/ops), and version. I have not removed this, since the data collected is very minimal and your IP cannot be saved, but I think this should be disclosed. If you wish to disable this, comment out the `anon_telemetry()` call at the bottom of interview_notify.py.
